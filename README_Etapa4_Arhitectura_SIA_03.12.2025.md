...
pentru simptome                | tastura input sub forma de text ce va|
                               ...
                               | ex. tuse acuta si febra 38.2 grade   |
---------------------------------------------------------------------------------------------------------
Interfata grafica pentru       |Stocare automată a imaginilor și textelor →|     UI (python)
upload imagine și input text   | în format JSON/CSV                        |Modul Data Logging / Acquisition
...
**Total observații finale:** 2350 radiografii (1250 radiografii clasificate Normal si 1100 imagini clasificate Viral Pneumonia) + inputuri text unice introdus de utilizator fiecarei radiografii  (după Etapa 3 + Etapa 4)
**Observații originale:** + inputuri unice text [M] (100% din datele generate, 
deoarece fiecare input text este unic, la fiecare introducere de imagine textul introdus va fi unic[X]%)

**Tipul contribuției:**
[] Date generate prin simulare fizică  
[ ] Date achiziționate cu senzori proprii  
[X] Etichetare/adnotare manuală/generare prin input textual
[ ] Date sintetice prin metode avansate  

**Descriere detaliată:**
Contribuția originală constă în generarea de inputuri text unice pentru fiecare imagine încărcată de utilizator. 
Fiecare input textual descrie simptomele pacientului (ex: „tuse severă, febră, durere în piept”) 
și este procesat printr-un dicționar Python în care fiecare simptom are un weight asociat pentru pneumonie.
...
image_id,text_input,prob_imagine,prob_text,prob_combined
img_001,"Am avut tuse și febră",0.78,0.65,0.72
img_002,"Durere în piept și oboseală",0.34,0.55,0.44
img_003,"Tuse severă, febră și ameteală",0.90,0.80,0.86
img_004,"Simt oboseală și durere de cap",0.12,0.30,0.21
```
